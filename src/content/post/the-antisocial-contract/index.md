...
- **India (Hindu-Muslim):** Backfire effect replicated; identity salience found as moderator ([Medin & Sachdeva, 2009](#ref-medin-2009))
- **Indonesia:** Within-subjects replication with madrassah students ([Ginges & Atran, 2009](#ref-ginges-atran-2009))
- **Iran:** N = 1,997 Iranians; backfire effect confirmed for sacralized nuclear program ([Dehghani et al., 2010](#ref-dehghani-2010))
- **Morocco and Spain:** N = 904; replicated effects for sharia and willingness to fight ([Sheikh, Gómez & Atran, 2016](#ref-sheikh-2016))
- **USA:** Three studies with Americans and Palestinians; religious ritual participation increases sacralization ([Sheikh, Ginges & Atran, 2013](#ref-sheikh-2013))
...
2. **Threats trigger threat responses**: Challenges to strongly held beliefs activate the amygdala and insula rather than deliberative reasoning regions ([Kaplan et al., 2016](#ref-kaplan-2016))
3. **Cost-benefit regions shut down**: fMRI shows *diminished* dlPFC, IFG, and parietal activity during sacred-value reasoning ([Hamid et al., 2019](#ref-hamid-2019))
4. **Rejection intensifies commitment**: Ostracism causes fused individuals to *increase* endorsement of extreme pro-group actions ([Gómez et al., 2011](#ref-gomez-2011))
5. **Misinformation accepted**: Fusion facilitates acceptance of identity-consistent information regardless of truth value ([Moniz & Swann, 2025](#ref-moniz-2025))

| Step | Process | Evidence |
|------|---------|----------|
| 1 | Group categorization creates us/them boundary | [Tajfel, 1971](#ref-tajfel-1971) |
| 2 | Identity fusion merges personal and group self | [Swann et al., 2012](#ref-swann-2012) |
| 3 | Group-associated values become sacred | [Atran & Ginges, 2012](#ref-atran-ginges-2012) |
| 4 | Challenges trigger threat response | [Kaplan et al., 2016](#ref-kaplan-2016) |
| 5 | Cost-benefit regions shut down | [Hamid et al., 2019](#ref-hamid-2019) |
| 6 | Analytical capacity redirected toward defense | [Bayrak et al., 2025](#ref-bayrak-2025) |
| 7 | Rejection intensifies commitment | [Gómez et al., 2011](#ref-gomez-2011) |
| 8 | Identity-aligned misinformation accepted | [Moniz & Swann, 2025](#ref-moniz-2025) |
...
The same pattern appears with secular identity systems. Economic crisis in Weimar Germany drove populations toward Nazi identity. Austerity policies during the Depression increased Nazi vote share, with effects concentrated among those just above the lowest economic strata who had more to lose ([Galofré-Vilà et al., 2021](#ref-galofre-vila-2021)). Post-Soviet collapse drove populations toward ethnic nationalism, as the sudden removal of Soviet identity structures triggered nationalist mobilization across nearly all ethnic regions ([Beissinger, 2002](#ref-beissinger-2002)). The 2008 financial crisis drove populations toward populist movements. Far-right party vote share increases by over 30% after financial crises, with effects strongest among middle classes facing sudden economic insecurity ([Funke et al., 2016](#ref-funke-2016); [Guiso et al., 2022](#ref-guiso-2022)). In each case, identity-providing institutions (religious, ideological, or political) offer genuine material and social support to people in crisis. This creates identity attachment in populations with few alternatives.
...
4. **Crisis exploitation.** Identity systems that provide genuine aid during crisis create attachment in vulnerable populations. This is not malicious; it is a structural feature. Lower-income Americans have higher levels of institutional religious participation; conflict-affected populations increase participation in identity-providing institutions ([ASPE](#ref-aspe); [Shayo & Zussman, 2022](#ref-shayo-2022)).

5. **Intergenerational transmission.** The most durable identity systems transmit across generations. How someone is raised is the single best predictor of adult identity commitment ([Voas & Crockett, 2005](#ref-voas-2005); [Voas & Storm, 2012](#ref-voas-2012)).

**The neural evidence confirms the mechanism is content-independent:**

Secular values (human life, health, nature, human rights) produce the same moral outrage and backfire effects as religious values when monetized ([Tetlock et al., 2000](#ref-tetlock-2000); [Baron & Spranca, 1997](#ref-baron-1997)). fMRI studies testing values ranging from mundane to religious to secular moral found that ALL sacred values activated the same neural regions. "The realm of the sacred, whether it's a strong religious belief, a national identity or a code of ethics, is a distinct cognitive process" ([Berns et al., 2012](#ref-berns-2012)).
...
- Fusion with Trump before 2020 predicted stronger belief in election fraud claims through 2024, creating a feedback loop reinforcing loyalty ([Moniz & Swann, 2025](#ref-moniz-2025))
- Three-wave panel around January 6th showed fusion predicts support for authoritarianism ([Martel et al., 2024](#ref-martel-2024))
- Seven studies showed Americans fused with Trump more willing to commit political violence and persecute immigrants and Muslims ([Kunst et al., 2019](#ref-kunst-2019))
...
Charismatic leadership plays a particularly crucial role in societies that are either poorly integrated or lack regularized administrative institutions ([Plamper, 2012](#ref-plamper-2012)). The pattern across cases:
...
The Soviet cult system replicated Orthodox Christian structures point-for-point ([Plamper, 2012](#ref-plamper-2012)):
...
The Khrushchev "Secret Speech" (1956) denouncing Stalin produced physical reactions in the audience (heart attacks and suicides) because *desacralization* of a figure around whom identity had been fused was experienced as psychologically devastating. This is identity fusion producing the predicted response: criticism of the sacred figure triggers the same defensive response as personal attack ([Swann et al., 2012](#ref-swann-2012)).
...
Exclusivism generates higher in-group cohesion, higher fertility, and more aggressive expansion. Pluralistic variants exist but are perpetually outcompeted by exclusivist variants ([Norenzayan, 2013](#ref-norenzayan-2013); [Gu et al., 2022](#ref-gu-2022)).

The evidence across identity types:

- **Religious:** Strict denominations outcompete inclusive ones. Southern Baptists grew 59% while Episcopalians declined 28% (1961–1998). Orthodox Jewish fertility (3.3) vs non-Orthodox (1.4) projects Orthodox share rising from 12% to 29% in 50 years ([Pew, 2015](#ref-pew-2015); [Pew, 2021](#ref-pew-2021)).
...
**Exclusivism suppresses innovation.** Across countries and U.S. states, religiosity is significantly negatively associated with patents per capita and favorable attitudes toward innovation, an effect that persists after controlling for GDP, education, and other variables ([Bénabou et al., 2015](#ref-benabou-2015)). The cohesion that mobilizes groups for competition suppresses the cognitive diversity that produces new ideas.

**Cohesion produces groupthink.** High group cohesion is "the most important antecedent" to groupthink, a decision-making failure mode where desire for unanimity overrides realistic assessment ([Janis, 1972](#ref-janis-1972)). The Bay of Pigs, the Challenger disaster, and the Iraq War all demonstrate how cohesive groups produce catastrophic decisions. At the group level, cohesion is strength; at the societal level, it is blindness.

**Belief helps; institutional cohesion hurts.** Religious *beliefs* are positively associated with economic growth, but religious *attendance* (the cohesion component) is negatively associated. The distinguishing variable is whether identity creates internal coordination or external closure ([Barro & McCleary, 2003](#ref-barro-mccleary-2003)).

**Extractive institutions cannot sustain growth.** When exclusivist groups capture societal institutions, those institutions become "extractive," concentrating power and resources while suppressing competition and innovation. Extractive institutions can produce short-term growth but cannot sustain it because they block the "creative destruction" that drives long-term development ([Acemoglu & Robinson, 2012](#ref-acemoglu-2012)).
...
|-------|-------------|--------|----------|
| Group vs. group | Strict vs. inclusive churches | Strict churches | [Iannaccone, 1994](#ref-iannaccone-1994) |
| Society vs. society | Extractive vs. inclusive institutions | Inclusive institutions | [Acemoglu & Robinson, 2012](#ref-acemoglu-2012) |
...
Elinor Ostrom won the Nobel Prize documenting exactly this: communities that successfully manage common-pool resources do so through institutional design that aligns individual and collective incentives ([Ostrom, 1990](#ref-ostrom-1990)).
...
**Ethnic riots as electoral technology:** Hindu-Muslim riots in India are strategically deployed political instruments. Politicians incite riots when they need to consolidate ethnic voting blocs; they prevent riots when they need minority support ([Wilkinson, 2004](#ref-wilkinson-2004)).

**Elite symbol manipulation:** Ethnic identity is not a fixed characteristic but a resource that elites mobilize for political purposes. Ethnic myths and symbols are deliberately manipulated to create politically useful identity categories ([Brass, 1991](#ref-brass-1991)).

**Identity categories as strategic choices:** In Zambia and Kenya, the shift from one-party to multiparty rule changed which ethnic identities were politically relevant, demonstrating that the identities themselves are interchangeable ([Posner, 2007](#ref-posner-2007)).

**Manufactured ethnic war:** Yugoslav leaders provoked ethnic conflict not because populations demanded it, but because elites needed exclusionary identity mobilization to maintain political relevance after socialism's collapse ([Gagnon, 2004](#ref-gagnon-2004)).
...
The American two-party system is a *minimal group paradigm at national scale*. It creates exactly the binary categorization that produces bias from nothing ([Tajfel et al., 1971](#ref-tajfel-1971)). Cross-cutting cleavages that prevent identity consolidation cannot survive when everything sorts into two bins.
...
<a id="ref-acemoglu-2012"></a>
**Acemoglu, D., & Robinson, J. A. (2012).** *Why Nations Fail: The Origins of Power, Prosperity, and Poverty*. Crown Business. [2024 Nobel Prize in Economics for related work on institutions.]

<a id="ref-aspe"></a>
**ASPE.** Role of religiosity in the lives of the low-income population: A comprehensive review. U.S. Department of Health and Human Services. https://aspe.hhs.gov/reports/role-religiosity-lives-low-income-population-comprehensive-review-evidence-0
...
<a id="ref-atran-2007"></a>
**Atran, S., Axelrod, R., & Davis, R. (2007).** Sacred barriers to conflict resolution. *Science*, 317(5841), 1039–1040. https://www.science.org/doi/10.1126/science.1144241

<a id="ref-atran-axelrod-2008"></a>
**Atran, S., & Axelrod, R. (2008).** Reframing sacred values. *Negotiation Journal*, 24(3), 221–246. https://direct.mit.edu/ngtn/article/24/3/221/122004/Reframing-Sacred-Values
...
<a id="ref-barro-mccleary-2003"></a>
**Barro, R. J., & McCleary, R. M. (2003).** Religion and economic growth across countries. *American Sociological Review*, 68(5), 760–781. https://www.nber.org/papers/w9682

<a id="ref-bayrak-2025"></a>
**Bayrak, R., Dogruyol, B., Alper, S., & Yilmaz, O. (2025).** Cognitive reflection and religious belief: A test of two models. *Judgment and Decision Making*, 20, e4. https://www.cambridge.org/core/journals/judgment-and-decision-making/article/cognitive-reflection-and-religious-belief-a-test-of-two-models/5EFE1B122D8D4DC44CF2F0F330D50C0B

<a id="ref-beissinger-2002"></a>
**Beissinger, M. R. (2002).** *Nationalist Mobilization and the Collapse of the Soviet State*. Cambridge University Press.

<a id="ref-benabou-2015"></a>
**Bénabou, R., Ticchi, D., & Vindigni, A. (2015).** Religion and innovation. *American Economic Review*, 105(5), 346–351. https://www.nber.org/papers/w21052

<a id="ref-berns-2012"></a>
**Berns, G. S., et al. (2012).** The price of your soul: Neural evidence for the non-utilitarian representation of sacred values. *Philosophical Transactions of the Royal Society B*, 367(1589), 754–762. https://pmc.ncbi.nlm.nih.gov/articles/PMC3260841/

<a id="ref-bird-2005"></a>
**Bird, K., & Sherwin, M. J. (2005).** *American Prometheus: The Triumph and Tragedy of J. Robert Oppenheimer*. Knopf.

<a id="ref-bishop-2008"></a>
**Bishop, B. (2008).** *The Big Sort: Why the Clustering of Like-Minded America Is Tearing Us Apart*. Houghton Mifflin.

<a id="ref-bjorkmark-2021"></a>
**Björkmark, M., Nynäs, P., & Koskinen, C. (2021).** "Living between two different worlds": Experiences of leaving a high-cost religious group. *Journal of Religion and Health*, 62, 1063–1082. https://link.springer.com/article/10.1007/s10943-021-01397-1

<a id="ref-brass-1991"></a>
**Brass, P. R. (1991).** *Ethnicity and Nationalism: Theory and Comparison*. Sage Publications.

<a id="ref-brown-1996"></a>
**Brown, A. (1996).** *The Gorbachev Factor*. Oxford University Press.

<a id="ref-campbell-2014"></a>
...
<a id="ref-butler-1989"></a>
**Butler, S. M. (1989).** Assuring affordable health care for all Americans. *The Heritage Lectures*, 218. Heritage Foundation.

<a id="ref-cialdini-2004"></a>
...
<a id="ref-cremer-2023b"></a>
**Cremer, T. (2023b).** The rise of the post-religious right: Christianism and secularism in the French Rassemblement National. *Party Politics*, 29(4), 613–624. https://journals.sagepub.com/doi/10.1177/13540688211046859

<a id="ref-dewaal-2014"></a>
...
<a id="ref-dehghani-2010"></a>
**Dehghani, M., et al. (2010).** Sacred values and conflict over Iran's nuclear program. *Judgment and Decision Making*, 5(7), 540–546. https://www.cambridge.org/core/journals/judgment-and-decision-making/article/sacred-values-and-conflict-over-irans-nuclear-program/46BB4FEA5A1B525413D6EC7F0F9384EC

<a id="ref-dikotter-2010"></a>
**Dikötter, F. (2010).** *Mao's Great Famine: The History of China's Most Devastating Catastrophe, 1958–1962*. Bloomsbury. [Samuel Johnson Prize winner.]
...
<a id="ref-fenelon-2016"></a>
**Fenelon, A., & Danielsen, S. (2016).** Leaving my religion: Understanding the relationship between religious disaffiliation, health, and well-being. *Social Science Research*, 57, 49–62. https://www.sciencedirect.com/science/article/abs/pii/S0049089X16000284

<a id="ref-freedman-1986"></a>
**Freedman, L. (1986).** *U.S. Intelligence and the Soviet Strategic Threat* (2nd ed.). Princeton University Press.

<a id="ref-funke-2016"></a>
...
<a id="ref-ginges-2007"></a>
**Ginges, J., Atran, S., Medin, D., & Shikaki, K. (2007).** Sacred bounds on rational resolution of violent political conflict. *PNAS*, 104(18), 7357–7360. https://www.pnas.org/doi/10.1073/pnas.0701768104

<a id="ref-ginges-atran-2009"></a>
**Ginges, J., & Atran, S. (2009).** Noninstrumental reasoning over sacred values: An Indonesian case study. In D. Bartels et al. (Eds.), *Psychology of Learning and Motivation, Vol. 50* (pp. 193–206). Academic Press. https://www.sciencedirect.com/science/article/abs/pii/S0079742108004064

<a id="ref-gomez-2011"></a>
**Gómez, Á., et al. (2011).** Rejected and excluded forevermore, but even more devoted. *Personality and Social Psychology Bulletin*, 37(12), 1574–1586. https://pubmed.ncbi.nlm.nih.gov/22045779/

<a id="ref-grigoryan-2022"></a>
**Grigoryan, L., et al. (2022).** Helping the ingroup versus harming the outgroup. *Journal of Experimental Social Psychology*, 105, 104436. https://www.sciencedirect.com/science/article/abs/pii/S002210312200155X

<a id="ref-gu-2022"></a>
**Gu, Y., Mao, C. X., & Johnson, T. (2022).** Evidence supporting a cultural evolutionary theory of prosocial religions. *Scientific Reports*, 12, 5239. https://www.nature.com/articles/s41598-022-09322-6

<a id="ref-guiso-2022"></a>
**Guiso, L., Herrera, H., Morelli, M., & Sonno, T. (2022).** Economic insecurity and the demand for populism in Europe. Working paper, Einaudi Institute for Economics and Finance. https://cepr.org/voxeu/columns/financial-crises-drivers-populism-new-channel

<a id="ref-hamid-2019"></a>
**Hamid, N., et al. (2019).** Neuroimaging 'will to fight' for sacred values. *Royal Society Open Science*, 6(6), 181585. https://pmc.ncbi.nlm.nih.gov/articles/PMC6599782/

<a id="ref-haynes-2020"></a>
**Haynes, J. (2020).** Right-wing populism and religion in Europe and the USA. *Religions*, 11(10), 490. https://www.mdpi.com/2077-1444/11/10/490

<a id="ref-henrich-2019"></a>
**Henrich, J., et al. (2019).** War increases religiosity. *Nature Human Behaviour*, 3, 129–135. https://www.nature.com/articles/s41562-018-0512-3
...
<a id="ref-johnson-2012"></a>
**Johnson, M. K., Rowatt, W. C., & LaBouff, J. P. (2012).** Religiosity and prejudice revisited. *Psychology of Religion and Spirituality*, 4(2), 154–168. https://psycnet.apa.org/doi/10.1037/a0025107

<a id="ref-kaplan-2016"></a>
**Kaplan, J. T., Gimbel, S. I., & Harris, S. (2016).** Neural correlates of maintaining one's political beliefs in the face of counterevidence. *Scientific Reports*, 6, 39589. https://www.nature.com/articles/srep39589

<a id="ref-keenan-2021"></a>
**Keenan, O., & Golec de Zavala, A. (2021).** Collective narcissism and weakening of American democracy. *Analyses of Social Issues and Public Policy*, 21(1), 237–258. https://doi.org/10.1111/asap.12274

<a id="ref-kershaw-2011"></a>
**Kershaw, I. (2011).** *The End: The Defiance and Destruction of Hitler's Germany, 1944–1945*. Penguin.

<a id="ref-khan-2007"></a>
**Khan, Y. (2007).** *The Great Partition: The Making of India and Pakistan*. Yale University Press.

<a id="ref-kivrak-2025"></a>
**Kivrak, E. (2025).** The transformation of Juche ideology into a polytheistic political religion. *Politics, Religion & Ideology*, 26(3). https://www.tandfonline.com/doi/full/10.1080/21567689.2025.2584222

<a id="ref-koenig-2025"></a>
**Koenig, B., & Mendelberg, T. (2025).** The symbolic politics of status in the MAGA movement. *Perspectives on Politics*. https://www.cambridge.org/core/journals/perspectives-on-politics/article/symbolic-politics-of-status-in-the-maga-movement/A22AC624B4D1FF7367D9912F23875F4B

<a id="ref-kornai-1992"></a>
**Kornai, J. (1992).** *The Socialist System: The Political Economy of Communism*. Princeton University Press.

<a id="ref-kramer-1999"></a>
**Kramer, M. (1999).** Ideology and the Cold War. *Review of International Studies*, 25(4), 539–576. https://www.cambridge.org/core/journals/review-of-international-studies/article/abs/ideology-and-the-cold-war/272D085482D22A30F32BF672A7FD439E
...
<a id="ref-menkhaus-2007"></a>
**Menkhaus, K. (2007).** Governance without government in Somalia: Spoilers, state building, and the politics of coping. *International Security*, 31(3), 74–106. https://direct.mit.edu/isec/article/31/3/74/11882/Governance-without-Government-in-Somalia-Spoilers
...
<a id="ref-ostrom-1990"></a>
**Ostrom, E. (1990).** *Governing the Commons: The Evolution of Institutions for Collective Action*. Cambridge University Press. [2009 Nobel Prize in Economics.]
...
<a id="ref-plamper-2012"></a>
**Plamper, J. (2012).** *The Stalin Cult: A Study in the Alchemy of Power*. Yale University Press. https://yalebooks.yale.edu/book/9780300169522/the-stalin-cult/
...
<a id="ref-saletan-2020"></a>
**Saletan, W. (2020).** "Defund the police" is a self-destructive slogan. *Slate*. https://slate.com/news-and-politics/2020/11/defund-police-slogan-election-polls-democrats.html
...
<a id="ref-schrecker-1998"></a>
**Schrecker, E. (1998).** *Many Are the Crimes: McCarthyism in America*. Little, Brown.

<a id="ref-shayo-2022"></a>
**Shayo, M., & Zussman, A. (2022).** Does armed conflict increase individuals' religiosity? *Social Science & Medicine*, 294, 114710. https://www.sciencedirect.com/science/article/abs/pii/S0277953622000727

<a id="ref-sheikh-2013"></a>
**Sheikh, H., Ginges, J., & Atran, S. (2013).** Religion, group threat and sacred values. *Judgment and Decision Making*, 8(2), 110–118. https://www.cambridge.org/core/journals/judgment-and-decision-making/article/religion-group-threat-and-sacred-values/03A14F993FE473F87D89C5772B668D83
...
<a id="ref-svensson-2018"></a>
**Svensson, I., & Nilsson, D. (2018).** Disputes over the divine: Introducing the RELAC data. *Journal of Conflict Resolution*, 62(5), 1127–1148. https://pmc.ncbi.nlm.nih.gov/articles/PMC6249647/

<a id="ref-swann-2012"></a>
**Swann, W. B., et al. (2012).** When group membership gets personal: A theory of identity fusion. *Psychological Review*, 119(3), 441–456. https://psycnet.apa.org/doi/10.1037/a0028589

<a id="ref-tajfel-1971"></a>
**Tajfel, H., Billig, M. G., Bundy, R. P., & Flament, C. (1971).** Social categorization and intergroup behaviour. *European Journal of Social Psychology*, 1(2), 149–178. https://onlinelibrary.wiley.com/doi/10.1002/ejsp.2420010202

<a id="ref-tetlock-2000"></a>
**Tetlock, P. E., et al. (2000).** The psychology of the unthinkable: Taboo trade-offs. *Journal of Personality and Social Psychology*, 78(5), 853–870. https://pubmed.ncbi.nlm.nih.gov/10821194/

<a id="ref-voas-2005"></a>
**Voas, D., & Crockett, A. (2005).** Religion in Britain: Neither believing nor belonging. *Sociology*, 39(1), 11–28. https://journals.sagepub.com/doi/10.1177/0038038505048998
...
<a id="ref-wilkinson-2004"></a>
**Wilkinson, S. (2004).** *Votes and Violence: Electoral Competition and Ethnic Riots in India*. Cambridge University Press.

<a id="ref-williams-2007"></a>
**Williams, K. D. (2007).** Ostracism. *Annual Review of Psychology*, 58, 425–452. https://doi.org/10.1146/annurev.psych.58.110405.085641

<a id="ref-woodward-1995"></a>
**Woodward, S. (1995).** *Balkan Tragedy: Chaos and Dissolution after the Cold War*. Brookings Institution Press.

<a id="ref-ysseldyk-2010"></a>
**Ysseldyk, R., Matheson, K., & Anisman, H. (2010).** Religiosity as identity: Toward an understanding of religion from a social identity perspective. *Personality and Social Psychology Review*, 14(1), 60–71. https://journals.sagepub.com/doi/10.1177/1088868309349693
...
- [The Antisocial Contract (Simple Version)](/posts/the-antisocial-contract/simple-version/): A simplified overview of the argument
- [The Democratic Trap](/posts/the-antisocial-contract/democratic-trap/): Structural solutions to sacred-value distortion in democracies
- [Scriptural Exclusivism](/posts/the-antisocial-contract/scriptural-exclusivism/): Testing whether scriptural exclusivist content predicts intergroup violence
- [Citation Meta-Analysis](/posts/the-antisocial-contract/citation-meta-analysis/): Verification status and links for all citations
- [Logical Leaps Audit](/posts/the-antisocial-contract/audit/): Audit of every inferential step in the argument chain
