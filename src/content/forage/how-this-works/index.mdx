...
publishDate: "2026-05-10T15:18:28-05:00"
...
## Five ways a dish gets locked in

Each promoted entry names the mechanism that keeps the dish geographically contained. There are five primary categories, drawn from the entries already in the survey.
...
A dish that requires a specific piece of equipment that has barely propagated outside the home region. Chicago's aquarium smokers for [rib tips and hot links](/posts/modern-forage-chicago/#chicago-hot-link--tip-and-link--chicago-south-side-1954). The Ball Cream Beater that anchors the [Cincinnati opera cream](/posts/modern-forage-cincinnati/#opera-cream--cincinnati-oh) tradition. The dish travels roughly as far as the apparatus does.

### Ingredient-distribution-locked

A dish that depends on a manufactured ingredient produced at national scale but distributed almost exclusively to the home metro because demand outside it is too thin to justify retail stocking. [Provel cheese](/posts/modern-forage-st-louis/#st-louis-style-pizza--st-louis-mo) is the canonical case: blended by Schreiber Foods in Green Bay, Wisconsin, then shipped to St. Louis grocery aisles in five-pound loaves while being effectively absent from grocery shelves outside the metro. Mail order from the manufacturer is the only out-of-region option. [Chicago-style giardiniera](/posts/modern-forage-chicago/#chicago-style-giardiniera--chicago-il) fits the same shape: V. Formusa Co. (est. 1898) manufactures the Marconi brand at scale, the producer themselves confirms "I am not aware of anyone producing the Chicago-style giardiniera in oil outside of the Chicago area," and the [Italian beef](/posts/modern-forage-chicago/#italian-beef--chicago-il) and [breaded steak sandwich](/posts/modern-forage-chicago/#breaded-steak-sandwich--chicago-il) traditions are built around it; Portillo's ships diaspora jars but retail distribution is essentially Chicago-only. The lock is downstream in the distribution network, not upstream in the production line. The mechanism is distinct from apparatus-locked because there is no special equipment that fails to propagate; a generic process line would do, and demand-side concentration is what keeps the ingredient in place.
...
A few entries layer mechanisms. The [cheese crown](/posts/modern-forage-cincinnati/#cheese-crown--cincinnati-oh) is immigrant-community-locked (Cincinnati's German-American bakery network) and apparatus-adjacent (the muffin-tin baking form that defines the cup-and-crown shape). Some entries land in a sixth informal category that has not been formalized: tribute-product-locked, where the dish itself is so embedded that local non-dish brands (Northside's Fish Logs Cider and Fish Logs gelato; Graeter's Cheese Crown ice cream) reproduce it in adjacent product categories. The tribute pattern is a load-bearing cultural-lock signal even when the dish itself has only one or two active vendors.
