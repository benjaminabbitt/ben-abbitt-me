...
excerptTemplate: "{Count} Cleveland-area dishes covering Polish, Italian, Black East-Side, and depression-era immigrant lineages."
geo:
  cbsa: "17410"
  primary_county: "39007"
  scope: city_wide
---
...
### Cleveland Cassata Cake — Cleveland, OH \{.dish\}
...
### Cleveland Brown Mustard (Bertman / Stadium) — Cleveland, OH — *containment caveat* \{.dish\}
...
### City Chicken (Cleveland-side) \{.dish\}
