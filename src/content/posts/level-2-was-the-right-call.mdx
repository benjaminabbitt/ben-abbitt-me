...
HITL for code is a review queue. Techniques like the [illuminated code walkthrough](/posts/deterministic-systems-non-deterministic-tools/) speed it up and make it thorough. HITL for architecture is a different shape: catching the Level 1 versus Level 2 decision **before the implementation exists**, not after.
