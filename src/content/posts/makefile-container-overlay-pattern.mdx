...
description: "How we eliminated conditionals from our Makefile while supporting both host and containerized builds through a single command interface."
publishDate: "2026-05-03T19:42:55-05:00"
tags: ["patterns", "tools"]
marginalia: "Same make command, host or container, no conditionals. The overlay pattern that finally made our builds boring."
---
...
For full implementation details, see the [angzarr repository](https://github.com/angzarr-io/angzarr) for working examples of this pattern.
