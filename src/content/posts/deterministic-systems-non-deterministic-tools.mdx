...
description: "Large Language Models are probabilistic text generators. So how do you build reliable software with unreliable assistants?"
publishDate: "2026-05-03T19:42:55-05:00"
tags: ["llm", "workflow", "testing"]
marginalia: "LLMs are probabilistic. The trick to building reliable software with them: don't ask for answers, ask for tools that produce answers."
---
