...
description: "Tests should live next to the code they test, in the same directory but a separate file. Not inline. Not in a parallel tree."
publishDate: "2026-05-13T20:58:59-05:00"
tags: ["testing", "patterns", "tools", "software-architecture"]
marginalia: "Tests live in the same directory as the code they test. Not inline, not in a parallel tree, next door."
---
...
- Clean [mutation testing](/posts/mutation-testing-validates-llm-tests/) workflow
