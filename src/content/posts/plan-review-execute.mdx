...
description: "The most effective LLM workflows force a pause between planning and execution. You wouldn't let a contractor start demolition before approving blueprints."
publishDate: "2026-05-03T19:42:55-05:00"
tags: ["llm", "workflow", "patterns"]
marginalia: "LLMs are biased toward action. The fix: a forced pause between planning and execution, treated as a contractor's blueprint review."
---
...
For a deeper treatment of illuminated walkthroughs and how they fit with test-driven development, see [Building Deterministic Systems with Non-Deterministic Tools](/posts/deterministic-systems-non-deterministic-tools/).
