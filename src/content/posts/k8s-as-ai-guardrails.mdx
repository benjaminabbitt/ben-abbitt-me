...
**Standalone mode was the right call to deprecate.** This experience reinforced why Angzarr dropped `angzarr-standalone` in [0.3.0](/posts/angzarr-core-0.3.0/). In-process variants are convenient for getting started, but they teach habits—and now train AIs—that break in distributed deployment. Better to start with the real topology.
